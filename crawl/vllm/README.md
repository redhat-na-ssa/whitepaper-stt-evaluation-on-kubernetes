...
1. Crawl vLLM onto Linux with Ubuntu base image for decoupled and embedded models [Start -> Ubuntu with vLLM](crawl/vllm/ubi9/README.md)
1. Crawl vLLM onto UBI9 from UBuntu for decoupled and embedded models [Next -> UBI9 with vLLM](crawl/vllm/ubuntu/README.md)
