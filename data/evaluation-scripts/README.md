...
## podman_container_monitor script
...
|processor/gpu name|	The GPU name (placeholder). In a real setup, replace this.|
|core/gpu count|	The number of CPU cores (used as a placeholder for GPU cores).|
|max usage (%)|	Maximum GPU usage (placeholder).|
|max gpu temperature (C)|	Maximum GPU temperature (placeholder).|
|max pwr|usage/cap (%)|	Maximum GPU power usage (placeholder).|
|max vram usage (%)|	Maximum VRAM usage (placeholder).|
|startup time (s)|	Time it took for the container to start (in seconds).|
|task time (s)|	Time the container was running (in seconds).|
|shutdown time (s)|	Time it took for the container to stop (in seconds).|
|total time (s)|	Total time from start to stop (in seconds).|
