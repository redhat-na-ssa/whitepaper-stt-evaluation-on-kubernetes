...
- **Why migrate to a cluster later?**
  - ⚙️ Scale: memory/compute limits reached.
...
- **Simple vs Complex Data:**
  ...
  - 🗣️ **JFK**: Long form, challenging transcription.
...
- Experiments to Run:
  ...
  - 🎛️ **Args vs Hyperparams** → leads to Pipelines, KAI Scheduler, CronJobs.
  - 🖥️ **CPU vs GPU** → rightsizing, NVIDIA MIG, scheduling policies.
...
- **Why scale beyond the workstation?**
  ...
  - 🗃️ Data Management: pipelines, versioning
