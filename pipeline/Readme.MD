...
#### roxctl-api-token-secret.yaml

Get the rox api token from the environment from acs namespace. and replace the content <<DOCKER CONFIG JSON FROM QUAY ACCOUNT>>
